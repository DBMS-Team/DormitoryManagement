...
CREATE TABLE [RELATIVE] (
	[USER_ID] BIGINT NOT NULL,						-- USER_ID ĐỊNH DANH LẤY USER ĐỂ LƯU THÔNG TIN
	[RELATIVE_USER_ID] BIGINT NOT NULL,				-- USER_ID CỦA NGƯỜI THÂN
	[RELATIONSHIP] NVARCHAR(20),					-- QUAN HỆ
	
	CONSTRAINT [PK_RELATIVE] PRIMARY KEY([USER_ID], [RELATIVE_USER_ID]),
	CONSTRAINT [FK_RELATIVE_USER] FOREIGN KEY ([USER_ID], [RELATIVE_USER_ID]) REFERENCES [USER]([USER_ID], [USER_ID]),
)
GO
